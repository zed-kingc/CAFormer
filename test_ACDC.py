...
from lib.networks import PVT_GCASCADE, MERIT_GCASCADE, PVT_UPGCASCADE
...
if __name__ == "__main__":
    ...
    if args.encoder=='PVT':
        ...
        net = PVT_UPGCASCADE(n_class=args.num_classes, img_size=args.img_size, k=11, padding=5, conv='mr', gcb_act='gelu', skip_aggregation=args.skip_aggregation).cuda()
    else:
