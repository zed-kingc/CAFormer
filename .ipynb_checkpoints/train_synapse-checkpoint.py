...
parser.add_argument('--batch_size', type=int,
                    default=24, help='batch_size per gpu') #6
...
if __name__ == "__main__":
    ...
    args.exp = str(args.encoder) + '_MUTATION_w3_7_Run1_' + dataset_name + str(args.img_size)
    ...
    elif args.encoder == 'SUNEXT':
        net = UNext(num_classes=args.num_classes, img_size=args.img_size, patch_size=24)
    else:
